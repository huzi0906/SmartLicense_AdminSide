...
#     try:
#         # Calculate total score (average of the three scores)
#         total_score = (
#             scorecard["reverse_parking_score"] +
#             scorecard["hands_on_steering_score"] +
#             scorecard["seatbelt_score"]
#         ) / 3.0

#         # Determine if the user passes (total score >= 20 out of 30)
#         has_licence = total_score >= 20 / 3.0  # 20/30 = 6.67/10
#         if(has_licence<5)
#         {
#             passTest=false,
#             hasLicence=false
...
#                     "passTest"=passTest,
#                     "hasLearnerLicence": False  # Reset learner licence status after test
#                 }
#             }
#         )
...
#             print(f"User with CNIC {cnic} found but no updates were made")
#             return False
#         print(f"Successfully updated scores for CNIC {cnic}")
#         return True
...
#         return False
#     except Exception as e:
#         print(f"Unexpected error while updating MongoDB: {e}")
#         return False

# def run_pipeline():
#     """
#     Run the preprocessing pipeline and update MongoDB with the results.
#     Uses hardcoded file paths and CNIC.
#     """
#     # Validate file paths
...
#     score, _ = evaluate_parking(SENSOR_FILE)
#     if score is None:
#         return {"error": "Reverse parking evaluation failed."}

#     # Run hands on wheel and seatbelt evaluation
#     _, _, hands_scorecard = predict_video_report(VIDEO_FILE)
#     if hands_scorecard is None:
...
#     # Update the user document with the scores
